...
- (map(object)) **`approle_auth_roles = {}`** _[since v0.0.4]_
    ...
    - (number) **`token_max_ttl_seconds = null`** _[since v0.0.4]_
    
        Specify the token's max TTL (time-to-live) in seconds

    - (number) **`token_ttl_seconds = null`** _[since v0.0.4]_
    
        Specify the token's TTL (time-to-live) in seconds

- (object) **`aws_auth_roles = {}`** _[since v0.0.7]_
    ...
    - (string) **`sts_role_arn`** _[since v0.0.7]_

        The IAM role Vault assume to validate authentication requests to IAM roles in this role

    - (list(string)) **`bound_iam_principal_arns = null`** _[since v0.0.7]_

        List of IAM arns that is allowed to authenticate using this role

    - (list(string)) **`token_policies`** _[since v0.0.7]_
    
        A list of Vault policies to be attached to tokens generated by this role

    - (number) **`token_max_ttl_seconds = null`** _[since v0.0.7]_
    
        Specify the token's max TTL (time-to-live) in seconds

    - (number) **`token_ttl_seconds = null`** _[since v0.0.7]_
    
        Specify the token's TTL (time-to-live) in seconds


- (object) **`aws_backend_credential = null`** _[since v0.0.7]_
    ...
    - (string) **`access_key_id`** _[since v0.0.7]_

        Access key ID of an IAM user

    - (string) **`secret_access_key`** _[since v0.0.7]_

        Secret access key of an IAM user

- (object) **`github_config = null`** _[since v0.0.3]_
    ...
    - (string) **`organization`** _[since v0.0.3]_

        The GitHub organization
    
    - (map(list(string))) **`teams = null`** _[since v0.0.3]_
    ...
    - (map(list(string))) **`users = null`** _[since v0.0.3]_
...
- (map(object)) **`kubernetes_auth_roles = {}`** _[since v0.0.2]_
    ...
    - (list(string)) **`token_policies`** _[since v0.0.2]_
    
        A list of Vault policies to be attached to tokens generated by this role

    - (list(string)) **`bound_service_account_names = null`** _[since v0.0.2]_

        A list of Kubernetes service account names that is permited to authenticate using this role

    - (list(string)) **`bound_service_account_namespaces = null`** _[since v0.0.2]_

        A list of Kubernetes namespaces that is permited to authenticate using this role
    
    - (number) **`token_max_ttl_seconds = null`** _[since v0.0.2]_
    
        Specify the token's max TTL (time-to-live) in seconds

    - (number) **`token_ttl_seconds = null`** _[since v0.0.2]_
...
- (map(object)) **`oidc_auth_roles = {}`** _[since v0.0.2]_
    ...
    - (list(string)) **`allowed_redirect_uris = null`** _[since v0.0.2]_

        A list of redirect URIs where authentication responses can be redirected back to the caller

    - (map(string)) **`bound_claims = null`** _[since v0.0.2]_
    ...
    - (string) **`groups_claim = null`** _[since v0.0.2]_

        The claim to use to uniquely identify the set of groups to which the user belongs

    - (list(string)) **`oidc_scopes = null`** _[since v0.0.2]_
    ...
    - (string) **`user_claim = null`** _[since v0.0.2]_
