...
variable "crl_configuration" {
  type = object({
    ...
    ///
    /// @link {crl-cloudfront} https://docs.aws.amazon.com/privateca/latest/userguide/crl-planning.html#s3-bpa
    /// @since 1.0.0
  ...
  description = <<EOT
    ...
    @link {certificate-revocation-list} https://docs.aws.amazon.com/privateca/latest/userguide/crl-planning.html
    @since 1.0.0
  EOT
  default     = null
}
...
variable "key_algorithm" {
  ...
  description = <<EOT
    ...
    @enum RSA_2048|RSA_4096|EC_prime256v1|EC_secp384r1
    @since 1.0.0
  EOT
  default     = "RSA_2048"
}
...
variable "ocsp_configuration" {
  type = object({
    ...
    ///
    /// @link {online-certificate-status-protocol} https://docs.aws.amazon.com/privateca/latest/userguide/ocsp-customize.html
    /// @since 1.0.0
...
variable "signing_algorithm" {
  ...
  description = <<EOT
    ...
    @enum SHA256WITHECDSA|SHA384WITHECDSA|SHA512WITHECDSA|SHA256WITHRSA|SHA384WITHRSA|SHA512WITHRSA
    @since 1.0.0
  EOT
...
variable "subordinate_ca_configuration" {
  type = object({
    ...
    ///
    /// @example "Deploy Subordinate Ca Signed By External Parent Ca" #deploy-subordinate-ca-signed-by-external-parent-ca
    /// @since 1.0.0
...
variable "usage_mode" {
  ...
  description = <<EOT
    ...
    @link {ca-mode} https://docs.aws.amazon.com/privateca/latest/userguide/short-lived-certificates.html
    @since 1.0.0
  EOT
