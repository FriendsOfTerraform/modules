...
variable "schedules" {
  type = map(object({
    ...
    target = object({
      ...
      ///
      /// @link {eventbridge-scheduler-universal-target} https://docs.aws.amazon.com/scheduler/latest/UserGuide/managing-targets-universal.html?icmpid=docs_console_unmapped
      /// @since 1.0.0
