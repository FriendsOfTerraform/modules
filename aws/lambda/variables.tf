...
variable "aliases" {
  type = map(object({
    ...
    ///
    /// @link {lambda-alias-routing} https://docs.aws.amazon.com/lambda/latest/dg/configuration-aliases.html#configuring-alias-routing
    /// @since 1.0.0
  ...
  description = <<EOT
    ...
    @example "Versioning And Aliases" #versioning-and-aliases
    @since 1.0.0
  EOT
  default     = {}
}
...
variable "asynchronous_invocation" {
  type = object({
    ...
    ///
    /// @link {asynchronous-invocation-destination-permission} https://docs.aws.amazon.com/lambda/latest/dg/invocation-async.html#invocation-async-destinations
    /// @since 1.0.0
  ...
  description = <<EOT
    ...
    @example "Asynchronous Invocation Configuration" #asynchronous-invocation-configuration
    @link {lambda-asynchronous-invocation} https://docs.aws.amazon.com/lambda/latest/dg/invocation-async.html
    @since 1.0.0
  EOT
  default     = null
}
...
variable "concurrency" {
  ...
  description = <<EOT
    ...
    @link {lambda-concurrency} https://docs.aws.amazon.com/lambda/latest/dg/configuration-concurrency.html
    @since 1.0.0
  EOT
  default     = null
}
...
variable "enable_active_tracing" {
  ...
  description = <<EOT
    ...
    @link {lambda-active-tracing} https://docs.aws.amazon.com/lambda/latest/dg/services-xray.html
    @since 1.0.0
  EOT
  default     = null
}
...
variable "enable_function_url" {
  ...
  description = <<EOT
    ...
    @link {lambda-function-url} https://docs.aws.amazon.com/lambda/latest/dg/lambda-urls.html
    @since 1.0.0
  EOT
  default     = null
}
...
variable "lambda_permissions" {
  ...
  description = <<EOT
    ...
    @example "Lambda Permission" #lambda-permission
    @since 1.0.0
  EOT
  default     = {}
}
...
variable "layer_arns" {
  ...
  description = <<EOT
    ...
    @link {lambda-layer} https://docs.aws.amazon.com/lambda/latest/dg/chapter-layers.html
    @since 1.0.0
  EOT
  default     = []
}
...
variable "runtime" {
  ...
  description = <<EOT
    ...
    @link {lambda-runtime} https://docs.aws.amazon.com/lambda/latest/dg/API_CreateFunction.html#SSS-CreateFunction-request-Runtime
    @since 1.0.0
  EOT
  default     = null
}
...
variable "vpc_config" {
  ...
  description = <<EOT
    ...
    @link {lambda-vpc-config} https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html
    @since 1.0.0
  EOT
  default     = null
}
